...
public class StatementDormSELECT {
    ...
    public static String selectCheckRoom() {
        return "SELECT * FROM `" + DataConfig.DB_DORM_ROOM + "` INNER JOIN (SELECT COUNT(*) AS `max`, `table`.`" + DataConfig.DB_DORM_REQUEST_ROOM_ID + "` FROM (SELECT DISTINCT(`" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ACCOUNT_ID + "`), `" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ROOM_ID + "` FROM `" + DataConfig.DB_DORM_REQUEST + "` LEFT JOIN `" + DataConfig.DB_DORM_REPORT + "` ON `" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ACCOUNT_ID + "` = `" + DataConfig.DB_DORM_REPORT + "`.`" + DataConfig.DB_DORM_REPORT_ACCOUNT_ID + "` LEFT JOIN `" + DataConfig.DB_DORM_RESIDENT + "` ON `" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ACCOUNT_ID + "` = `" + DataConfig.DB_DORM_RESIDENT + "`.`" + DataConfig.DB_DORM_RESIDENT_ACCOUNT_ID + "` INNER JOIN `" + DataConfig.DB_DORM_ROOM + "` ON `" + DataConfig.DB_DORM_ROOM + "`.`" + DataConfig.DB_DORM_ROOM_ID + "` = `" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ROOM_ID + "` WHERE `" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ACCOUNT_ID + "` != ? AND `" + DataConfig.DB_DORM_REQUEST + "`.`" + DataConfig.DB_DORM_REQUEST_ROOM_ID + "` = ? AND (`" + DataConfig.DB_DORM_REPORT + "`.`" + DataConfig.DB_DORM_REPORT_STATUS + "` < 4 OR `" + DataConfig.DB_DORM_RESIDENT + "`.`" + DataConfig.DB_DORM_RESIDENT_CHECK_OUT + "` >= ?)) AS `table`) AS `table` ON `" + DataConfig.DB_DORM_ROOM + "`.`" + DataConfig.DB_DORM_ROOM_ID + "` = `table`.`" + DataConfig.DB_DORM_REQUEST_ROOM_ID + "` WHERE `table`.`max` < `" + DataConfig.DB_DORM_ROOM + "`.`" + DataConfig.DB_DORM_ROOM_MAX + "`";
    }
}
